 ...
 * @generated */
public class WatsonFS extends TOP {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(WatsonFS.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected WatsonFS() {/* intentionally empty block */}
   ...
   */
  public WatsonFS(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
